...
class m171019_131329_create_users_table extends Migration {
    ...
    public function up() {
        ...
        $this->createIndex(
                'idx-users-user_type_id', self::USERS_TABLE, 'user_type_id'
        );

        // add foreign key for table `el_user_types`
        $this->addForeignKey(
                'fk-users-user_type_id', self::USERS_TABLE, 'user_type_id', self::USER_TYPES_TABLE, 'user_type_id', 'CASCADE'
        );

        $this->insert('{{%users}}', ['user_type_id' => '1', 'name' => 'Admin', 'email' => 'admin@gmail.com']);
    }
    ...
    public function down() {
        echo "m171019_131329_create_users_table cannot be reverted.\n";
        return false;
    }
